...
const Hero = () => {
    return (
        <section className="relative bg-white pt-28 pb-12 overflow-hidden">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
                    ...
                    <div className="flex-1 max-w-2xl lg:py-12 order-2 lg:order-1">
                        ...
                        <p className="text-lg lg:text-xl text-text-secondary mb-8 leading-relaxed max-w-xl">
                            Social Adda is a modern influencer ecosystem where brands and creators collaborate through authentic content and measurable campaigns.
                        </p>
